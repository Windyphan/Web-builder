...
class WebDevChatbot:
    ...
    def load_model(self):
        ...
        try:
            ...
            # Go up one level from api/ to server/, then into models/
            model_dir = os.path.join(script_dir, "..", "models")

            # Resolve the absolute path to avoid path issues
    ...
    def chat(self, user_input, confidence_threshold=0.7):
        ...
        try:
            ...
            if confidence < confidence_threshold:
                response = "I'm not entirely sure what you're asking about. Could you please rephrase your question or be more specific about your web development needs?"
                intent = 'uncertain'
            else:
